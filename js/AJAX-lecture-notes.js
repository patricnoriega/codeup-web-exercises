...
// $.ajax("https://hookb.in/NOPLxk0bxwFe8mNN8mG9").done(function(data){
//     console.log(data);
// })
...
// $.ajax("https://hookb.in/NOPLxk0bxwFe8mNN8mG9",
//     {
//         type: "POST",
//         data: {
//             cohort: "Quasar",
...
// })
//
// $.ajax("https://www.themealdb.com/api/json/v1/1/categories.php\n").done(function (data){
//     console.log(data);
// })
...
// In action:
// $.ajax("https://www.themealdb.com/api/json/v1/1/random.php")  //fire off an ajax request to "url"
